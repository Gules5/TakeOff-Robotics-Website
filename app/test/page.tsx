...
export default function Home() {
  ...
  return (
    <div className="relative min-h-1000 bg-[#f2e8cf] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-start z-20 overflow-hidden pt-24">
        ...
        />
        <div className="text-center px-0 w-full max-w-[100vw] relative z-10 mt-0 space-y-4 ">
          <motion.h1 
            className="text-6xl sm:text-7xl md:text-8xl lg:text-[9vw] font-black [-webkit-text-stroke:3px_black] tracking-tighter uppercase whitespace-nowrap inline-block"
            style={{ 
               color: '#ED1C24',
            ...
            {letters.map((letter, index) => (
              <motion.span
                key={index}
                className="inline-block -mx-1 pr-2"
          ...
          {/* 5. MISSION SECTION */}
        <section className="my-24 mx-6 relative z-20 flex justify-center">
